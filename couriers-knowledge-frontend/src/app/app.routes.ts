...
export const routes: Routes = [
  ...
  {
    path: '',
    loadChildren: () => import('./views/public/public.routes').then(m => m.PUBLIC_ROUTES)
  },

  // Rotas do usuário logado (aponta para user.routes.ts)
  {
    path: 'app',
    loadChildren: () => import('./views/user/user.routes').then(m => m.USER_ROUTES),
  ...
  {
    path: 'premium',
    loadChildren: () => import('./views/premium/premium.routes').then(m => m.PREMIUM_ROUTES)
  },
